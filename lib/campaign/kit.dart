...
class Tack {
  ...
  String get iconPath => Atlas.tack(sprite);
...
class Consumable {
  ...
  String get iconPath => switch (kind) {
    ConsumableKind.feed => Atlas.feed(sprite),
    ConsumableKind.remedy => Atlas.remedy(sprite),
    ConsumableKind.supplement => Atlas.herb(sprite),
  };
