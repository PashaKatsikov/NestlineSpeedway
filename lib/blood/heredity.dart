...
class Heredity {
  ...
  /// Bloodline notation, e.g. `Lb DE Tw PP Cn hh`.
  ...
  static Heredity random(Dice rng, {double recessiveBias = 0.0}) {
    final out = <int>[];
    for (final l in Locus.values) {
  ...
  /// runs dry.
  static Heredity plain() =>
      Heredity(Locus.values.expand((l) => const [0, 0]).toList());
}
...
class Pairings {
  ...
  static List<Pairing> matching(Heredity g) =>
...
class Build {
  ...
  static const List<String> baseManeuvers = [
    'push',
    'push',
    'steady',
    'steady',
  ...
  static Build of(Heredity g) {
    var mods = Alleles.baseline;
    final expressed = <Allele>[];
    final pure = <Allele>[];
    final commands = <String>[...baseManeuvers];
