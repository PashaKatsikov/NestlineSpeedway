...
/// until an allele is in here, so the Ledger is a gameplay system rather than a
...
class Ledger {
  ...
  List<String> observe(Heredity g) {
    ...
    for (final s in Pairings.matching(g)) {
  ...
  String? reveal(Heredity g, Locus l) {
  ...
  int get completion {
    final parts = <double>[
      ...
      synergies.length / Pairings.all.length,
    ];
