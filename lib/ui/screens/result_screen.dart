...
class ResultScreen extends StatelessWidget {
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        ...
                        if (payout.eggTier >= 0)
                          _Line(
                            iconAsset: Sprites.egg(payout.eggTier),
                            tint: Palette.tiers[payout.eggTier],
                            label: '${EggTier.at(payout.eggTier).name} egg',
  ...
  void _leave(BuildContext context, Game game) {
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(label, style: Type.title(13, color: tint)),
                Text(value, style: Type.text(11)),
              ],
            ),
          ),
        ],
