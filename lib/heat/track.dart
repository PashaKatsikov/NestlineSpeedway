...
extension TerrainInfo on Terrain {
  ...
  Color get tint => switch (this) {
    Terrain.straight => Pigment.momentum,
    Terrain.corner => Pigment.amber,
    ...
    Terrain.downhill => Pigment.stamina,
    Terrain.crowd => Pigment.schoolRainbow,
  };
...
class Venue {
  ...
  static const List<Venue> all = [
    Venue(
      ...
      plate: Backdrops.trackDay,
      scenePlate: 'assets/plates/bg4.webp',
      segments: 7,
    ...
    Venue(
      ...
      plate: Backdrops.trackDay,
      scenePlate: 'assets/plates/bg3.webp',
      segments: 6,
    ...
    Venue(
      ...
      plate: Backdrops.trackDay,
      scenePlate: 'assets/plates/bg2.webp',
      segments: 8,
    ...
    Venue(
      ...
      plate: Backdrops.trackAutumn,
      scenePlate: 'assets/plates/bg7.webp',
      segments: 8,
    ...
    Venue(
      ...
      plate: Backdrops.trackAutumn,
      scenePlate: 'assets/plates/bg6.webp',
      segments: 8,
    ...
    Venue(
      ...
      plate: Backdrops.trackNight,
      scenePlate: 'assets/plates/bg1.webp',
      segments: 9,
    ...
    Venue(
      ...
      plate: Backdrops.trackDay,
      scenePlate: 'assets/plates/bg5.webp',
      segments: 10,
    ...
    Venue(
      ...
      plate: Backdrops.trackNight,
      scenePlate: 'assets/plates/bg8.webp',
      segments: 9,
...
class Track {
  ...
  static Track generate(Venue venue, Dice rng, {int laps = 1, int grade = 0}) {
