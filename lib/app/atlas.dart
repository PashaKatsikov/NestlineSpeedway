...
/// individual transparent PNGs under `assets/cut/<category>/`; the sheets
/// themselves live in `tool/sheets/` and are not shipped.
class Atlas {
  Atlas._();

  static const String _gen = 'assets/cut';
...
class Backdrops {
  ...
  static const String trackDay = 'assets/plates/tracks/sunhill.jpg';
  static const String trackNight = 'assets/plates/tracks/midnight.jpg';
  static const String trackAutumn = 'assets/plates/tracks/autumn.jpg';

  static const int sceneCount = 8;
  static String scene(int i) => 'assets/plates/bg${(i % sceneCount) + 1}.webp';
}
