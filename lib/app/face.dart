...
class Face {
  ...
  static TextStyle number(double size, {Color color = Pigment.ink}) =>
      TextStyle(
        fontFamily: display,
        fontSize: size,
        color: color,
  ...
  static TextStyle label(double size, {Color color = Pigment.inkMute}) =>
      TextStyle(
        fontFamily: body,
        fontSize: size,
